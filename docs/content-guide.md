  ...
  posts/                      ← Meta-blog: milestones and publication history
    emiliano-montesdeoca/
      my-post-slug/
        ...
        index.es.md
        ...
  tutorials/                  ← Step-by-step guides for AWS builders
    emiliano-montesdeoca/
      my-tutorial-slug/
        index.md
        index.es.md
...
```yaml
---
title: "Getting Started with Blazor in AWS 9"
date: 2025-12-01
...
| `role` | Recommended | Role/title shown under the name (e.g., `"Senior AWS Engineer"`) |
...
location: "Virtual"
featured: true
description: "The biggest AWS event of the year."
tags:
  - aws
  - conference
---
