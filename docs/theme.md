...
The custom theme lives at `themes/aws-minimal/`.

---

## Design

The **aws-minimal** theme is built from scratch with a developer-first aesthetic:
...
Edit the CSS custom properties at the top of `themes/aws-minimal/static/css/style.css`:
...
```toml
[params]
  description  = "Articles, tutorials and insights from the AWS community."
  eyebrow      = "The AWS Community Blog"
  hero_title   = 'Where <span class="accent">AWS builders</span><br/>share what they build.'
